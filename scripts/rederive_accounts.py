...
用法：
  python3 scripts/gmb.py               # dry-run，仅打印差异
  python3 scripts/gmb.py --apply       # 写回源码
"""
...
PRIMITIVES_DIR = Path(__file__).resolve().parent.parent / "citizenchain" / "runtime" / "primitives"
