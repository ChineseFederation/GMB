...
- `ffi/`：仅供归档 Dart/smoldot ARM64 差分测试的 legacy `smoldot_*` 与
...
差分测试仍由逐文件哈希保护。产品 ABI 投影覆盖 Android ARM64、iOS 设备 ARM64、
`iOS-Simulator` ARM64 与 macOS（仅支持 ARM64 架构）。legacy 宿主 dylib 只允许作为源码树外 ARM64
