...
typedef AttachmentLimitResolver = int Function(ChatMessageKind kind);
...
class MediaCompressor {
  ...
  Future<String> ensureWithinLimit({
    ...
    final limit = _limitForKind(kind);
