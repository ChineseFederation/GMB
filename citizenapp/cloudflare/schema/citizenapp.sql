-- CitizenApp Cloudflare D1 唯一创世 schema 基线。
...
CREATE TABLE user_projection_cursor (
...
CREATE INDEX idx_square_login_challenges_expires
...
CREATE INDEX idx_square_sessions_expires
...
CREATE INDEX idx_square_creator_subscriptions_state
...
CREATE INDEX idx_square_uploads_completed
...
CREATE INDEX idx_square_media_cid_number
...
CREATE INDEX idx_square_posts_cid_number_type
  ON square_posts(cid_number, post_state, post_type, created_at);
CREATE INDEX idx_square_posts_state
...
CREATE INDEX idx_square_follows_follower
  ON square_follows(follower_cid_number, created_at, followed_cid_number);
CREATE INDEX idx_square_follows_notify
  ON square_follows(
    followed_cid_number,
    notify_enabled,
    created_at,
...
CREATE INDEX idx_resource_reservations_expires
...
CREATE UNIQUE INDEX idx_chat_push_endpoints_token
