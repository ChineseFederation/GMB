// libchat_sdk native 库探测（Chat OpenMLS 使用独立原生库）。
//
...
// (`chatsdk/native/src/mls.rs` / `chatsdk/lib/src/mls/mls_native.dart`)后,必须先产宿主库
...
//
// 设备构建会 `cargo clean` ChatSDK native target；统一测试入口与 `citizenapp-run.sh`
...
String? chatSdkNativeSkipReason() {
  ...
  try {
    ...
    _reason = 'libchat_sdk native 库不可用；请改用 '
