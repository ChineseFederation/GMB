...
class _ComposerBarState extends State<ComposerBar> {
          ...
          children: [
            ...
            Padding(
              padding: EdgeInsets.fromLTRB(
                AppLayout.scaled(context, 8),
                AppLayout.scaled(context, 7),
                AppLayout.scaled(context, 8),
                AppLayout.scaled(context, 7) + (panelOpen ? 0 : safeBottom),
              ),
              child: Row(
  ...
  Widget _buildInputArea(BuildContext context) {
    return ConstrainedBox(
      constraints: BoxConstraints(
        minHeight: AppLayout.scaled(context, _inputControlHeight),
      ),
      child: DecoratedBox(
        ...
        decoration: BoxDecoration(
          ...
          borderRadius: BorderRadius.circular(AppLayout.scaled(context, 10)),
        ),
        child: Row(
          crossAxisAlignment: CrossAxisAlignment.center,
          children: [
  ...
  Widget _buildTextField(BuildContext context) {
    final lineHeight = AppLayout.scaled(context, _inputTextLineHeight);
    return ConstrainedBox(
      ...
      child: TextField(
        ...
        style: TextStyle(
          fontSize: AppLayout.scaled(context, _inputTextFontSize),
  ...
  Widget _buildVoiceButton(BuildContext context) {
    ...
    return Listener(
      ...
      onPointerMove: (event) {
        ...
        final cancel = target == _VoiceDragTarget.cancel ||
      ...
      child: AnimatedContainer(
        ...
        height: AppLayout.scaled(context, _inputControlHeight),
        ...
        child: Text(
          ...
          style: TextStyle(
            ...
            color: _cancelBySlide ? Colors.red : AppTheme.textPrimary,
          ),
        ),
      ),
    );
  ...
  Widget _roundIconButton({
    ...
    return SizedBox(
      ...
      height: AppLayout.scaled(context, buttonHeight),
      child: IconButton(
        tooltip: tooltip,
        ...
        onPressed: onTap,
        icon: Icon(icon, size: AppLayout.scaled(context, 30)),
      ),
    );
  }
  ...
  void _measure() {
    ...
    context
        ...
        .setHeight(box.size.height - safeBottom);
  }
}
...
class _VoiceRecordingOverlay extends StatelessWidget {
          ...
          child: Align(
            ...
            child: Padding(
              ...
              padding: EdgeInsets.only(
                bottom: AppLayout.scaled(context, 148),
              ),
              child: Material(
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    borderRadius: BorderRadius.circular(
                      AppLayout.scaled(context, 24),
                    ),
                    boxShadow: [
                      BoxShadow(
                        color: Colors.black.withValues(alpha: 0.24),
                        blurRadius: AppLayout.scaled(context, 24),
                        offset: Offset(0, AppLayout.scaled(context, 10)),
                      ),
                    ],
                  ),
                  child: Row(
                    ...
                    children: [
                      ...
                      SizedBox(
                        width: AppLayout.scaled(context, 70),
                        child: Column(
                          mainAxisSize: MainAxisSize.min,
                          children: [
                            Icon(
                              ...
                              color: centerColor,
                              size: AppLayout.scaled(context, 38),
                            ),
  ...
  Widget _arcTarget(
    ...
    final outerRadius = Radius.circular(AppLayout.scaled(context, 34));
    final innerRadius = Radius.circular(AppLayout.scaled(context, 12));
    return Semantics(
      key: ValueKey(
      ...
      child: AnimatedContainer(
        key: key,
        duration: const Duration(milliseconds: 120),
        width: AppLayout.scaled(context, 82),
        ...
        decoration: BoxDecoration(
          ...
          border: Border.all(
            ...
            width: AppLayout.scaled(context, selected ? 2 : 1),
          ),
        ...
        child: Column(
          ...
          children: [
            Icon(icon, color: color, size: AppLayout.scaled(context, 24)),
