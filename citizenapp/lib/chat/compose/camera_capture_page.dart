...
class _CameraCapturePageState extends State<CameraCapturePage>
  ...
  void _beginVideoGesture() {
    ...
    unawaited(created.whenComplete(() {
      ...
      body: SafeArea(
        child: Stack(
          ...
          children: [
            ...
            Positioned(
              left: AppLayout.scaled(context, 8),
            ...
            if (_recording)
              Positioned(
                top: AppLayout.scaled(context, 18),
                left: 0,
                right: 0,
                child: Text(
            ...
            if (_error != null)
              Positioned(
                left: AppLayout.scaled(context, 20),
                right: AppLayout.scaled(context, 20),
                bottom: AppLayout.scaled(context, 140),
                child: Text(
                  _error!,
                  textAlign: TextAlign.center,
            ...
            Positioned(
              left: 0,
              right: 0,
              bottom: AppLayout.scaled(context, 28),
              child: Column(
                ...
                children: [
                  ...
                  GestureDetector(
                    ...
                    child: AnimatedContainer(
                      ...
                      width: AppLayout.scaled(context, _recording ? 76 : 70),
                      height: AppLayout.scaled(context, _recording ? 76 : 70),
